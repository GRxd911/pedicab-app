...
import * as CommuterAuth from './auth.js';
import * as CommuterRides from './rides.js';
import * as CommuterProfile from './profile.js';
import * as CommuterChat from './chat.js';
import * as AudioService from '../../shared/js/services/audio.js';
import {
    initMap,
    addMarker,
    addDriverMarker,
...
import {
    ...
    calculateDistance
} from '../../shared/js/services/location.js';
import { applyTheme, activateSOSUI, showConfirm, showAlert } from '../../shared/js/utils/ui.js';
...
async function setupRideMap(ride) {
    ...
    clearAllMarkers();
    clearRoute();
    lastRouteCalcTime = 0; // Force immediate route draw on first load
...
window.openChat = (rideId, driverName) => {
    ...
    // 2. Fast Fallback Polling (Guarantees delivery every 2.5s)
